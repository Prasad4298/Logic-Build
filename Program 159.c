/*
Q.4) Write a program which accept one number and position from user and toggle that bit.
...
int main()
{
	...
	printf("Toggle Bit at that position and MOdified number is : %lu",Ret);
	return 0;
}
